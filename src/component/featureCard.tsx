import { Features } from "@/types/interface";
...
const FeatureCard : FC<FeatureCardProps> = ({title,imageUrl,content}) => {
    ...
    <article className="w-full md:max-w-[30rem] lg:max-w-[36rem] border-2 border-transparent 
    rounded-lg py-4 px-8 hover:bg-slate-800 hover:border-sky-600 cursor-pointer " >
