 import { Pricing, PricingMode } from "@/types/interface";
...
const PricingCart : FC<PricingCartProps> = ({annuallyPrice,
    description,
    features,
    monthlyPrice,
    title,
    ...
    return <article className={`relative w-full py-6 px-4 flex flex-col space-y-4 lg:space-y-6
        ${isMostPopular?
            ...
            :"border border-slate-700" }
             rounded-lg overflow-hidden `}>
               ...
               {isMostPopular && (
                <p className="absolute top-5 right-6 bg-sky-600 text-white text-xl 
                    font-semibold capitalize py-2 px-3 rounded-3xl" >most popular</p>
                    ) }
